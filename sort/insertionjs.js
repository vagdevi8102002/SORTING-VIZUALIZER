...
arr.map(e => {
  if(e === new window.URLSearchParams(window.location.search).get('type'))
  document.querySelector('#navbarDropdownMenuLink').innerHTML = e

})
//console.log(arr.find(e == new window.URLSearchParams(window.location.search).get('type')))
